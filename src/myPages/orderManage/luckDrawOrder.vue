<template>
  <div class="app-container luckDrawOrder-container">
    ...
    <el-dialog title="好运订单详情" :visible.sync="dialogFormVisible">
      <luckDrawOrderDetail :data-obj="detailData" />
    </el-dialog>
  </div>
</template>
